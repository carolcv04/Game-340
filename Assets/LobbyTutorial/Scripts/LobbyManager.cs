...
using Unity.Services.Authentication; // ADD THIS LINE
...
public class LobbyManager : MonoBehaviour {
    ...
    public async System.Threading.Tasks.Task Authenticate(string playerName) {
        ...
        isInitialized = true; // ADD THIS LINE - This is what's missing!
        Debug.Log("Authentication complete - Services initialized!"); // Optional confirmation
    }
    ...
    public async void CreateLobby(string lobbyName, int maxPlayers, bool isPrivate, GameMode gameMode) {
        if (!isInitialized) {
            Debug.LogError("Cannot create lobby: Services not initialized. Call Authenticate first.");
            return;
        }
